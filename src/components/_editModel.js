...
const EditEnergy = () => {
  ...
  const handleLoadAll = async () => {
    try {
      ...
      const response = await axios.get(`https://springboot-production-1101.up.railway.app/model/getModelById/${idModel}`, {
        headers: {
  ...
  const handleEdit = async () => {
    try {
      ...
      const response = await fetch(`https://springboot-production-1101.up.railway.app/model/update/${idModel}`, {
        method: "PUT",
        headers: {
          Authorization: `Bearer ${token}`,
