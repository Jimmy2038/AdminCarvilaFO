...
const EditEnergy = () => {
  ...
  const handleLoadAll = async () => {
    ...
    try {
      ...
      const response = await axios.get(`https://springboot-production-1101.up.railway.app/energie/getById/${idEnergy}`, {
        headers: {
  ...
  const handleEdit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://springboot-production-1101.up.railway.app/energie/update/${idEnergy}`, {
        method: "PUT",
        headers: {
          Authorization: `Bearer ${token}`,
