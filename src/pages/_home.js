...
const Home = () => {
  ...
  const handleLoadAll = async () => {
    try {
      ...
      const response = await axios.get("https://springboot-production-1101.up.railway.app/ByMarque", {
        headers: {
  ...
  const handleLoadVente = async () => {
    try {
      ...
      const response = await axios.get("https://springboot-production-1101.up.railway.app/vente", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
